...
Формат (без форматирования, без звёздочек, простой текст):

Название: [1-2 слова на английском]

Суть: [1 предложение - что это и для кого]

Как работает: [3 пункта через запятую]

Деньги: [как монетизировать, 1 предложение]

Старт: [конкретное действие на сегодня]
