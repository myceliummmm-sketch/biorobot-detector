...
- упоминай ОЧЕНЬ редко, только если человек сам спрашивает про продукт или жалуется на блокеры/прокрастинацию
- не рекламируй без повода, это раздражает
- максимум 1 раз на 15-20 сообщений, и то если реально к месту
